...
from .views import Department_AddView,Department_UpdateView,Department_DeleteView,document_lcic_List_idView
...
from .views import PersonalEducationCreateView,sidebar_View
...
urlpatterns = [
    ...
    path('users/<str:username>/', UserView.as_view(), name='user-update-delete'),
    ...
    path("api/update-view-status/<int:doc_id>/", update_view_status, name="update_view_status"),
    ...
    path("update_status/<int:doc_id>/", update_view_status, name="update_view_status"),
